function dphi = zIdPhi2(dx,dy,time0,m,d,postSmoothing)
...
%dphi = foaw_diff(uphi, Ts, m, d,postSmoothing);

% ddy = dxdt(dy,dT,window,postSmoothing);
% ddx = dxdt(dx,dT,window,postSmoothing);
ddx = foaw_diff_varTs(dx, time0, m, d,postSmoothing);
ddy = foaw_diff_varTs(dy, time0, m, d,postSmoothing);
