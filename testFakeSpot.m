figure(1); clf;
ix = interp1(time0,frame0,timeOut0,'nearest')+1;
...
scatter(x0(ix),y0(ix),40,amp0,'filled');
...
scatter(time0(ix),y0(ix),40,amp0,'filled');
...
scatter(x0(ix),time0(ix),40,amp0,'filled');
